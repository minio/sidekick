...
func TestProxy(t *testing.T) {
	...
	proxyHandler := NewSingleHostProxy(backendURL)
...
// header value.
func TestProxyStripHeadersPresentInConnection(t *testing.T) {
...
func TestProxyStripEmptyConnection(t *testing.T) {
	// See Issue 46313.
	const backendResponse = "I am the backend"
...
func TestProxyQuery(t *testing.T) {
	...
	for i, tt := range proxyQueryTests {
		...
		frontend := httptest.NewServer(NewSingleHostProxy(backendURL))
...
func TestProxy_NilBody(t *testing.T) {
...
func TestProxy_AllocatedHeader(t *testing.T) {
...
func TestProxyModifyResponse(t *testing.T) {
	...
	rproxy := NewSingleHostProxy(rpURL)
...
func TestProxyErrorHandler(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			rproxy := NewSingleHostProxy(target)
...
func TestProxy_CopyBuffer(t *testing.T) {
	...
	// channel to ensure that the Proxy's ServeHTTP is done before we
	// continue after Get.
	<-donec
}
...
func TestProxyWebSocket(t *testing.T) {
	...
	rproxy := NewSingleHostProxy(backURL)
	...
	if !asciiEqualFold(upgradeType(res.Header), "websocket") {
...
func TestProxyWebSocketCancellation(t *testing.T) {
	n := 5
	...
	rproxy := NewSingleHostProxy(backendURL)
	rproxy.ModifyResponse = func(res *http.Response) error {
		res.Header.Add("X-Modified", "true")
		return nil
	}
	...
	if g, w := upgradeType(res.Header), "websocket"; !asciiEqualFold(g, w) {
...
func TestProxyQueryParameterSmugglingDirectorDoesNotParseForm(t *testing.T) {
	testProxyQueryParameterSmuggling(t, testWantsRawQuery, func(u *url.URL) *Proxy {
		proxyHandler := NewSingleHostProxy(u)
		oldDirector := proxyHandler.Director
		proxyHandler.Director = func(r *http.Request) {
			oldDirector(r)
		}
...
func TestProxyQueryParameterSmugglingDirectorParsesForm(t *testing.T) {
	testProxyQueryParameterSmuggling(t, testWantsCleanQuery, func(u *url.URL) *Proxy {
		proxyHandler := NewSingleHostProxy(u)
		oldDirector := proxyHandler.Director
		proxyHandler.Director = func(r *http.Request) {
			// Parsing the form causes Proxy to remove unparsable
...
func testProxyQueryParameterSmuggling(t *testing.T, wantCleanQuery bool, newProxy func(*url.URL) *Proxy) {
	backend := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
